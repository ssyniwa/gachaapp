...
# ステージごとにクエストを分ける
quest_pools = {
    1: [("森を探索した", 10, 10), ("ボススライムを倒した", 20, 15)],
    2: [("洞窟を探索した", 20, 25), ("迷いの森を抜けた", 30, 30)],
    3: [("古の遺跡を探索した", 30, 40), ("遺跡を守るゴーレムを倒した", 40, 50)],
    4: [("古の遺跡を探索した", 30, 40), ("遺跡を守るゴーレムを倒した", 40, 50)],
    5: [("古の遺跡を探索した", 30, 40), ("遺跡を守るゴーレムを倒した", 40, 50)],
    6: [("古の遺跡を探索した", 30, 40), ("遺跡を守るゴーレムを倒した", 40, 50)],
    7: [("古の遺跡を探索した", 30, 40), ("遺跡を守るゴーレムを倒した", 40, 50)],
    8: [("古の遺跡を探索した", 30, 40), ("遺跡を守るゴーレムを倒した", 40, 50)],
    9: [("古の遺跡を探索した", 30, 40), ("遺跡を守るゴーレムを倒した", 40, 50)],
    10: [("古の遺跡を探索した", 30, 40), ("遺跡を守るゴーレムを倒した", 40, 50)]  
}
# --- クエリパラメータ取得 ---
