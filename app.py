...
quest_pools = {
    ...
    2: [("洞窟を探索した", 30, 30), ("エリアボスコウモリを倒した", 40, 40),("鉱石採取した",10,10),("洞窟の地形を記録した",0,10),("盗賊を捕獲",10,20)],
    3: [("古の遺跡を探索した", 40, 40), ("エリアボスゴーレムを倒した", 50, 50),("珍しい薬草採取した",10,10),("遺跡の地形を記録した",0,10),("盗賊を捕獲",10,20)],
    4: [("灼熱の火口を探索した", 50, 50), ("エリアボスファイアゴーレムを倒した", 60, 60),("耐炎の薬草採取した",10,10),("火口の地形を記録した",0,10)],
    5: [("極寒の地を探索した", 60, 60), ("ボスアイスフェアリーを倒した", 70, 70),("耐冷の薬草採取した",10,10),("極寒の地の地形を記録した",0,10)],
    6: [("暴風の草原を探索した", 70, 70), ("ボスウィンドウルフを倒した", 80, 80),("薬草採取した",10,10),("森の地形を記録した",0,10)],
    7: [("雷撃の丘を探索した", 80, 80), ("ボスサンダーバードを倒した", 90, 90),("薬草採取した",10,10),("森の地形を記録した",0,10)],
    8: [("毒霧の沼を探索した", 90, 90), ("ボスポイズンフロッグを倒した", 100, 100),("薬草採取した",10,10),("森の地形を記録した",0,10)],
    9: [("天空の城を探索した", 100, 100), ("ボスコピーゴッドを倒した", 110, 110),("薬草採取した",10,10),("森の地形を記録した",0,10)],
    10: [("悪魔の拠点を探索した", 110, 110), ("ボスブラックドラゴンを倒した", 120, 120),("薬草採取した",10,10),("森の地形を記録した",0,10)]  
}
# --- クエリパラメータ取得 ---
