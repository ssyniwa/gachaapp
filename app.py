...
# ステージごとにクエストを分ける
quest_pools = {
    1: [("森を探索した", 20, 20), ("エリアボススライムを倒した", 30, 30),("薬草採取した",10,10),("森の地形を記録した",0,10),("盗賊を捕獲",10,20)],
    2: [("洞窟を探索した", 30, 30), ("エリアボスコウモリを倒した", 40, 40),("鉱石採取した",20,20),("洞窟の地形を記録した",10,20),("盗賊を捕獲",20,30)],
    3: [("古の遺跡を探索した", 40, 40), ("エリアボスゴーレムを倒した", 50, 50),("珍しい薬草採取した",30,30),("遺跡の地形を記録した",20,30),("盗賊を捕獲",30,40)],
    4: [("灼熱の火口を探索した", 50, 50), ("エリアボスファイアゴーレムを倒した", 60, 60),("珍しい薬草採取した",40,40),("火口の地形を記録した",30,40)],
    5: [("極寒の地を探索した", 60, 60), ("ボスアイスフェアリーを倒した", 70, 70),("珍しい薬草採取した",50,50),("極寒の地の地形を記録した",40,50)],
    6: [("暴風の草原を探索した", 70, 70), ("ボスウィンドウルフを倒した", 80, 80),("珍しい薬草採取した",60,60),("草原の地形を記録した",50,60)],
    7: [("雷撃の丘を探索した", 80, 80), ("ボスサンダーバードを倒した", 90, 90),("珍しい薬草採取した",70,70),("雷撃の丘の地形を記録した",60,70)],
    8: [("毒霧の沼を探索した", 90, 90), ("ボスポイズンフロッグを倒した", 100, 100),("珍しい薬草採取した",80,80),("毒霧の沼の地形を記録した",70,80)],
    9: [("天空の城を探索した", 100, 100), ("ボスコピーゴッドを倒した", 110, 110),("珍しい薬草採取した",90,90),("天空の城の地形を記録した",80,90)],
    10: [("悪魔の拠点を探索した", 110, 110), ("ボスブラックドラゴンを倒した", 120, 120),("珍しい薬草採取した",100,100),("悪魔の拠点の地形を記録した",90,100)]  
}
# --- クエリパラメータ取得 ---
